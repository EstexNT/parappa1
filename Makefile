...
CPP     := $(CROSS)-cpp
CC      := $(TOOLS_DIR)/gcc-2.6.0-psx/cc1
...
OPT_FLAGS           := -O0
ENDIAN              := -EL
INCLUDE_FLAGS       := -Iinclude/psyq -Iinclude -I $(BUILD_DIR) -Isrc/prr.bin
DEFINE_FLAGS        := -D_LANGUAGE_C -DUSE_INCLUDE_ASM -DLANGUAGE_C
...
# Comods do not use small sections/GP

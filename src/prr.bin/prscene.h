...
#define PR_SCN_FLAG_400       (1 << 10)
#define PR_SCN_FLAG_800       (1 << 11)
#define PR_SCN_FLAG_1000      (1 << 12)
#define PR_SCN_FLAG_2000      (1 << 13)
#define PR_SCN_FLAG_4000      (1 << 14)
#define PR_SCN_FLAG_8000      (1 << 15)
#define PR_SCN_FLAG_10000     (1 << 16)
#define PR_SCN_FLAG_20000     (1 << 17)
#define PR_SCN_FLAG_40000     (1 << 18)
#define PR_SCN_FLAG_80000     (1 << 19)
#define PR_SCN_FLAG_100000    (1 << 20)
#define PR_SCN_FLAG_200000    (1 << 21)
#define PR_SCN_FLAG_400000    (1 << 22)
#define PR_SCN_FLAG_800000    (1 << 23)
#define PR_SCN_FLAG_1000000   (1 << 24)
#define PR_SCN_FLAG_2000000   (1 << 25)
#define PR_SCN_FLAG_4000000   (1 << 26)
#define PR_SCN_FLAG_8000000   (1 << 27)
#define PR_SCN_FLAG_10000000  (1 << 28)
#define PR_SCN_FLAG_20000000  (1 << 29)
#define PR_SCN_FLAG_40000000  (1 << 30)
#define PR_SCN_FLAG_80000000  (1 << 31)
